                ...
                if(e.getClickCount() == 2 && tbl_studentRegisteredCourses.getSelectedRow() != -1){
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            CoursesGUI studentGUI = new CoursesGUI(anonStudentGUI, selectedCourseID, selectedContentID, selectedPatikaID);
        ...
        btn_showCourses.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(tbl_studentPatikalar.getSelectedRow() == -1) {
                    Helper.showMsg("Lütfen listeden bir Patika seçiniz!");
                    return;
                }
