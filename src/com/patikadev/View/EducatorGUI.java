...
public class EducatorGUI extends JFrame {
    ...
    public EducatorGUI(Educator educator){
        ...
        btn_addContent.addActionListener(e -> {
            ContentGUI contentGUI = new ContentGUI(this, this.educator);
        ...
        btn_deleteContent.addActionListener(e -> {
            if(!updateEnabled) {
                Helper.showMsg("Lütfen silmek için listeden bir içerik seçiniz!");
                return;
            }
        ...
        btn_addQuiz.addActionListener(e -> {
            if(Helper.isTextFieldEmpty(fld_addQuizName) || cmb_addQuizCourse.getSelectedItem() == null){
                Helper.showMsg("fill");
            }else{
    ...
    public void loadCourseModel(){
        ...
        for(Course obj : Course.getListByUser(this.educator.getId())){
            ...
            row_courseList[i++] = obj.getUser_id();
            row_courseList[i++] = obj.getPatika_id();
