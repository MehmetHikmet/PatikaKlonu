...
public class CoursesGUI extends JFrame {
    ...
    public CoursesGUI(StudentGUI studentGUI, int courseID, int contentID, int patikaID){
        this.rating = -1;
        ...
        btn_rate.addActionListener(e -> {
            ...
            if(rdbtn_1.isSelected() || rdbtn_2.isSelected() || rdbtn_3.isSelected() || rdbtn_4.isSelected() || rdbtn_5.isSelected()){
                ...
                Helper.showMsg("Lütfen bir puan seçiniz!");
            }
        });

        btn_comment.addActionListener(e -> {
            if(Helper.isTextFieldEmpty(fld_comment)){
                Helper.showMsg("fill");
            }else{
        ...
        if(r != null){
            ...
            switch (r.getRating()){
                ...
                case 5:
                    ...
                    break;
                default:
                    Helper.showMsg("Bilinmeyen değerlendirme puanı: " + r.getRating() + " !");
            }
